...
List<Conversation> _conversations = [
  new Conversation()
    ..deidentifiedPhoneNumber = 'ahso-asgo-qbal'
    ..demographicsInfo = 'Female, 28, East'
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'glar-bgls-paxb'
    ..demographicsInfo = 'Male, 16, East'
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'alha-pcaa-vass'
    ..demographicsInfo = 'Female, 46, West'
    ..tags = []
    ..messages = [
      new Message()
        ..direction = MessageDirection.In
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'agso-ashk-chls'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'ahls-cnhl-flas'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'jala-blas-ohsa'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'ahls-bxks-mahs'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'blad-qhla-zblh'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'asha-bcka-ylja'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'ghla-ghjl-yuio'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'hals-ashk-werj'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'mnbx-vbnm-dfgh'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'dfgh-jhga-sdfg'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'erty-poiu-werj'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'oiuy-hjkl-jhgf'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'lklk-hkjk-upoq'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'dfua-agsk-slkd'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'ooiw-ppqp-hlkk'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
  ...
  new Conversation()
    ..deidentifiedPhoneNumber = 'zbvx-zxcc-bvxm'
    ..demographicsInfo = ''
    ..tags = []
    ..messages = [
      new Message()
